...
> Status: **CLOSED by operator (2026-06-08)** — audyt kompletny; implementacja w generatorze **nieplanowana** (by design)
...
## Operator decision (2026-06-08) — Problem 7 CLOSED

**Decyzja:** PDF oferty w `top-instal-generator` zostaje jak jest. Brak mapowania pełnego OfferDTO → offer PDF **nie jest P0** ani błędem — świadoma decyzja produktowa.

| Wątek                            | Status                                     |
| -------------------------------- | ------------------------------------------ |
| Problem 7 (OfferDTO → offer PDF) | **Zamknięty** — implementacja nieplanowana |
| P0-2 `floor_area` w UI           | **Poprawne** — nie implementować           |
| P0-5/6 koszty roczne w UI        | **Poprawne** — nie implementować           |

**Nie mylić z:** raportem energii w kalk-top (`kalkulator/js/pdfGenerator.js`) — ta ścieżka renderuje OZC/koszty; oferta handlowa PDF = osobny produkt w generatorze.
