...
| Generator / ingress / ecosystem   | `docs/SOURCE_OF_TRUTH_INDEX.md`, `docs/ecosystem/TOPINSTAL_ECOSYSTEM_STATE.md`, `docs/ecosystem/TOPINSTAL_ECOSYSTEM_UPDATE_PROTOCOL.md`, relevant runbooks                                                                                                     | `docs/TOPINSTAL_CANONICAL_ENTITY_MODEL.md`, `docs/TOPINSTAL_EVENT_MODEL.md` |
| Doc-only governance work          | `docs/DOC_GOVERNANCE.md`, `docs/SOURCE_OF_TRUTH_INDEX.md`, `docs/DOC_INVENTORY_AND_CLASSIFICATION.md`, `docs/DOC_CONFLICTS_AND_GAPS.md`, `docs/AGENT_EXECUTION_STANDARD.md`                                                                                    | `docs/README.md`, `docs/HANDBOOK.md`                                        |
| Agent / operating-model work      | `docs/AGENT_EXECUTION_STANDARD.md`, `docs/TOPINSTAL_AI_OS_BLUEPRINT.md`, `docs/TOPINSTAL_CANONICAL_ENTITY_MODEL.md`, `docs/TOPINSTAL_EVENT_MODEL.md`                                                                                                           | `docs/agent/*` vision docs, ecosystem docs                                  |
