...
| Generator integration             | kalk-top adapter code + generator endpoint implementation                                                             | `docs/ecosystem/TOPINSTAL_ECOSYSTEM_STATE.md`, `docs/runbooks/offer-generator-integration-audit.md`, `docs/architecture/offer-dto-pdf-mapping-audit.md` | generator remains downstream renderer; **Problem 7 CLOSED 2026-06-08** (by design) |
