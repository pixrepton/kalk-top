# Legacy root filenames → canonical docs

Wcześniej w katalogu głównym leżały osobne pliki-wskaźniki. Poniżej mapa **stara nazwa → aktualna lokalizacja** (żeby nie gubić zakładek i skryptów).

| Legacy file               | Canonical document                                                             |
| ------------------------- | ------------------------------------------------------------------------------ |
