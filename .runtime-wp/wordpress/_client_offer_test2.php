...
$res = $client->generate_offer($params, array('traceId'=>'client-test-2','leadId'=>'lead-test-2','offerDto'=>$offer));
$out = wp_json_encode($res, JSON_UNESCAPED_UNICODE|JSON_PRETTY_PRINT);
if (!is_string($out)) { $out = json_encode($res); }
echo $out . PHP_EOL;
?>
