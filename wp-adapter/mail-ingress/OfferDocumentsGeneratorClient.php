...
foreach ($topinstal_offer_documents_client_candidates as $topinstal_offer_documents_client_path) {
    if (is_file($topinstal_offer_documents_client_path)) {
        require_once $topinstal_offer_documents_client_path;
        $topinstal_offer_documents_client_loaded_from = $topinstal_offer_documents_client_path;
        break;
    }
}

$GLOBALS['topinstal_offer_documents_client_bootstrap'] = array(
    'loadedFrom' => $topinstal_offer_documents_client_loaded_from,
    'candidates' => $topinstal_offer_documents_client_candidates,
    'classAvailable' => class_exists('TopInstal_OfferDocumentsGeneratorClient'),
);
